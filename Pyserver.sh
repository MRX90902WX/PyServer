...
setterm -foreground green
echo "---------------------------------------------"
echo -e "\e[1;35m [1].\e[0m\e[1;36mNavegar por los Directorios Termux \e[0m"
echo -e "\e[1;35m [2].\e[0m\e[1;36mNavegar en Directorios /sdcard \e[0m"
echo -e "\e[1;35m [3].\e[0m\e[1;36mNavegar en /sdcard \e[0m"
setterm -foreground green
echo "---------------------------------------------"
